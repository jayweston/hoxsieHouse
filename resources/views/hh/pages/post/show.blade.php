...
@section('content')
	...
	<div class="post-shares">
		<li  ><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{ $post->url }}" title="Share on Facebook" ><i class="fab fa-facebook fa-2x post-share"></i></a></li>
		<li  ><a target="_blank" href="https://twitter.com/home?status={{ $post->url }}" target="_blank" title="Share on Twitter" ><i class="fab fa-twitter fa-2x post-share"></i></a></li>
		<li  ><a target="_blank" href="https://pinterest.com/pin/create/button/?url={{ $post->url }}&media={{ $post->thumbnailPath() }}&description=" target="_blank" title="Share on Pinterest" ><i class="fab fa-pinterest fa-2x post-share"></i></a></li>
		<li  ><a target="_blank" href="https://plus.google.com/share?url={{ $post->url }}" target="_blank" title="Share on Google+" ><i class="fab fa-google-plus-square fa-2x post-share"></i></i></a></li>
		<li class="dropdown">
			...
			<div class="dropdown-menu post-show-dropdown" aria-labelledby="dropdownMenuLink">
				<a target="_blank" class="post-show-emailshare" href="https://mail.google.com/mail/?view=cm&fs=1&su=Check out this blogpost!&body=I thought you would like to read this post: {{ $post->url }}"   title="Share via Gmail"><img src="/hh/images/icon/mail/gmail.png" /> Gmail</a>
				<a target="_blank" class="post-show-emailshare" href="https://outlook.live.com/default.aspx?rru=compose&subject=Check out this blogpost!&body=I thought you would like to read this post: {{ $post->url }}"   title="Share via Hotmail"><img src="/hh/images/icon/mail/hotmail.png" /> Hotmail</a>
				<a target="_blank" class="post-show-emailshare" href="http://compose.mail.yahoo.com/?subj=Check out this blogpost!&body=I thought you would like to read this post: {{ $post->url }}"   title="Share via Yahoo"><img src="/hh/images/icon/mail/yahoo.png" /> Yahoo</a>
				<a target="_blank" class="post-show-emailshare" href="http://mail.aol.com/mail/compose-message.aspx?subject=Check out this blogpost!&body=I thought you would like to read this post: {{ $post->url }}"   title="Share via AOL"><img src="/hh/images/icon/mail/aol.png" /> AOL</a>
				<a target="_blank" class="post-show-emailshare" href="mailto:?subject=Check out this blogpost!&body=I thought you would like to read this post: {{ $post->url }}"  title="Share via mail"><img src="/hh/images/icon/mail/general.png" /> Other</a>
			</div>
		</li>
	</div>
