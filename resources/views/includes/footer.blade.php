<div class="footer-section">
	...
	<ul class="list-inline text-center footer-nav-link">
		<li><a target="_blank" href="http://crafts.hoxsiehouse.com/" title="Nite Owl Creates">Nite Owl Creates</a></li>
		<li><a target="_blank" href="http://stacieplace.hoxsiehouse.com/" title="Stacie's Place">Stacie's Place</li>
		<li><a target="_blank" href="http://travel.hoxsiehouse.com/" title="Tony & Stacie Travel">Travel</a></li>
		<li><a target="_blank" href="http://stacie.hoxsiehouse.com/" title="Redcherries">Red Cherries</a></li>
		<li><a target="_blank" href="http://wedding.hoxsiehouse.com/" title="Our Wedding">Wedding</a></li>
		@if (!Auth::guest()) @if (Auth::user()->type == App\Models\User::TYPE_ADMIN)<li><a target="_blank" href="http://private.hoxsiehouse.com/" title="Personal Blog">Private</a></li> @endif @endif
	</ul>
	@section('scripts')
