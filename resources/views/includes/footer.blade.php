<div class="footer-section">
	...
	<ul class="list-inline text-center footer-nav-link">
		...
		@if (!Auth::guest()) @if (Auth::user()->type == App\Models\User::TYPE_ADMIN)<li><a target="_blank" href="http://www.azhottness.blogspot.com/" title="Personal Blog">Private</a></li> @endif @endif
	</ul>
	@section('scripts')
