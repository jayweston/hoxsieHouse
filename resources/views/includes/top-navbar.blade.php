<nav role="navigation" class="navbar navbar-default">
	<div id="navbarCollapse" class="collapse navbar-collapse"><div class="container"><div class="row"><div class="col-md-10 col-md-offset-1">
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="" id=""><a class="" data-svc="facebook" data-svc-id="TheStaciesPlace" title="Follow on Facebook" href="http://www.facebook.com/TheStaciesPlace" target="_blank"><i class="fab fa-facebook"></i></a></li>
			<li class="" id=""><a class="" data-svc="instagram" data-svc-id="StaciesPlace" title="Follow on Instagram" href="http://instagram.com/StaciesPlace" target="_blank"><i class="fab fa-instagram"></i></a></li>
			<li class="" id=""><a class="" data-svc="twitter" data-svc-id="Stacies_Place" title="Follow on Twitter" href="http://twitter.com/intent/follow?source=followbutton&amp;variant=1.0&amp;screen_name=Stacies_Place" target="_blank"><i class="fab fa-twitter"></i></a></li>
			<li class="" id=""><a class="" data-svc="pinterest" data-svc-id="Stacies_Place" title="Follow on Pinterest" href="http://www.pinterest.com/Stacies_Place" target="_blank"><i class="fab fa-pinterest"></i></a></li>
			<li class="" id=""><a class="" data-svc="snapchat" data-svc-id="staciesplace" title="Follow on Snapchat" href="https://www.snapchat.com/add/staciesplace" target="_blank"><i class="fab fa-snapchat"></i></a></li>
			@if (Auth::guest())
				<li class="" id="nav_login"><a href="{{ route('login').'?redirect='.Request::path() }}">Login</a></li>
				<li class="" id="nav_register"><a href="{{ route('register').'?redirect='.Request::path() }}">Register</a></li>
			@else
