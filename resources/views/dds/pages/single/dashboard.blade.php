		...
		<div class="row">
			<div class="col align-self-center">
				<ul class="list-unstyled text-center">
					...
					<li class="dashboard_social_icons"><a href="/" target="_blank" title="Placeholder link"><span class="fa fa-instagram fa-3x"></span></a></li>
					<li class="dashboard_social_icons"><a href="/" target="_blank" title="Placeholder link"><span class="fa fa-pinterest-p fa-3x"></span></a></li>
					<li class="dashboard_social_icons"><a href="/" target="_blank" title="Placeholder link"><span class="fab fa-patreon fa-3x"></span></a></li>
					<li class="dashboard_social_icons"><a href="/" target="_blank" title="Placeholder link"><span class="fab fa-etsy fa-3x"></span></a></li>
				</ul>
			</div>
			<div class="col-10">
				<div class="card-deck">
					@foreach(App\Models\dds\Drawing::SITE_CATEGORIES as $key => $category)
						<div class="card dashboard_category_card mx-auto">
							<h5 class="mx-auto"><a href="/drawings/pencil/{{ $category }}/"> {{ $category }}</a></h5>
							<a href="/drawings/pencil/{{ $category }}/">
