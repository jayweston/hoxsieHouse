				...
				@foreach($pieces as $key => $piece)
					<div class="col">
						<div class="card drawings_category_card mx-auto">
							<a href="/drawings/pencil/{{ $piece->getPieceCategories()[0] }}/{{ $piece->title }}"><img class="card-img-top" src="{{ asset('dds/images/pieces/'.$piece->jpg) }}" alt="Pencil drawing titled: {{ $piece->title }}"></a>
							<div class="card-body">
