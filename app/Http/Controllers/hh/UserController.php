...
class UserController extends Controller
{
	...
	*/
	public function create()
	{
		...
		return view('hh.pages.user.create');
	}
	/*
	...
	*/
	public function index()
	{
		...
		return view('hh.pages.user.index', $view_data);
	}
	/*
	...
	*/
	public function show($id)
	{
		...
		$view_data['user'] = $user;
		return view('hh.pages.user.show', $view_data);
	}
	/*
	...
	*/
	public function edit($id)
	{
		...
		$view_data['user'] = $user;
		return view('hh.pages.user.edit', $view_data);
	}
	/*
